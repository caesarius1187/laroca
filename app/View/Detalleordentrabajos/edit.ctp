...
<?php echo $this->Form->create('Detalleordentrabajo'); ?>
	<fieldset>
		<legend><?php echo __('Edit Detalleordentrabajo'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Detalleordentrabajo.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Detalleordentrabajo.id'))); ?></li>
