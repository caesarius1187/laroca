			...
			<div id='cssmenu'>
				<ul>				  
				      ...
				      <ul>
					    <li class='has-sub'>
							<?php
								echo $this->Html->link("Lista de Clientes",
																array(
																	'controller' => 'clientes', 
																	'action' => 'index', 
																	)
					    ...
					    <li class='has-sub'>
				         	<?php
								echo $this->Html->link("Tipo de Clientes",
																array(
						...
						<li class='has-sub'>
				         	<?php
								echo $this->Html->link("Lista Ordenes de Trabajo",
																array(
				        ...
				        <li class='has-sub' style="display:none ">
				         	<?php
								echo $this->Html->link("Mano de Obra",
																array(
				      ...
				      <ul>					      				    
					    <li class='has-sub'>
				         	<?php
								echo $this->Html->link("Lista de Productos",
																array(
				      ...
				      <ul>					    
					    <li class='has-sub'>
				         	<?php
								echo $this->Html->link("Lista de Compras",
																array(
																	 'controller' => 'compras', 
																	 'action' => 'index', 
																 	 ) 
				      ...
				      <ul>					    
					    <li class='has-sub'>
				         	<?php
								echo $this->Html->link("Lista de Ventas",
																array(
																	 'controller' => 'ventas', 
																	 'action' => 'index', 
																 	 ) 
