...
<div id="ContenidoCompras_Add" class="compras">
	...
	<table cellpadding="0" cellspacing="0" class="tbl_add">
		<tr>
			<td colspan="4">
				<h2><?php echo __('Agregar Egreso'); ?></h2>
			</td>
		</tr>
		<tr>
			<td></td>
			...
			<td><?php echo $this->Form->input('mediodepago', array(
					'label' => 'Medio de pago',
		...
		<tr>
			...
			<td style="width:25%">
				<div class='input select' style="margin-top:17px">
					<input id="btnAgregarProducto" type="button" value="Agregar Item" class="btn_ot" onClick="checkearProducto()" />
				</div>
			</td>
			<td>
			</td>
