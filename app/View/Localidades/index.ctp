<div class="localidades index">
	...
	<tr>
		<td><?php echo h($localidade['Localidade']['id']); ?>&nbsp;</td>
		<td><?php echo h($localidade['Localidade']['nombre']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($localidade['Partido']['nombre'], array('controller' => 'partidos', 'action' => 'view', $localidade['Partido']['id'])); ?>
		</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $localidade['Localidade']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $localidade['Localidade']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $localidade['Localidade']['id']), null, __('Are you sure you want to delete # %s?', $localidade['Localidade']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
